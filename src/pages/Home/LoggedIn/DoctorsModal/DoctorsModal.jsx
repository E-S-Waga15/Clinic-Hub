...
import { fetchDoctorsBySpecialty, clearDoctors } from '../../../../store/slices/doctorsSlice';
import './DoctorsModal.css';

const DoctorsModal = ({ isOpen, onClose, selectedSpecialty, selectedSpecialtyId, onBook }) => {
        ...
        <div className="doctors-modal-body">
          {loading ? (
            ...
            <div className="doctors-slider-container">
              {isLargeScreen && (
                <button className="slider-button prev" onClick={handlePrevClick}><FaChevronLeft /></button>
              )}
              ...
              {isLargeScreen && (
                <button className="slider-button next" onClick={handleNextClick}><FaChevronRight /></button>
              )}
            </div>
          )}
        </div>
